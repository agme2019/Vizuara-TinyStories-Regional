...
<ul>
  <p><li>Prompts are generated by sampling a unique set of noun, verb, adjective and feature</li></p>
  ...
  <p></p><li>Prompt templates/complexities can be referred to/modified through <code>create_prompts.py</code>.</li> 
...
<ul>
  <p><li>Prompts are read from the file/shards and "sent" to the specified LLM (using <a href="https://github.com/xtekky/gpt4free">G4F</a>)</li></p> 
  ...
  <p><li>Please look into <code>make_requests.py</code> for customizing the prompting schema</li></p>
  <p><li>Please look into <code>request_helper.py</code> for a detailed look into the process</li>
      <ul>
        <li>Various regex (data cleanup) features</li>
        <li>API/LLM is prompted until a valid story is generated for each prompt</li>
      </ul></p>
  <p><li>To start the data generation process, please run the file <code>make_requests.py</code></li></p>
</ul>
